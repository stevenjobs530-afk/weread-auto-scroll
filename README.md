...
文字通过微信读书自身的排版过程重新换行，不会横向拉伸。章节的总高度随内容变化，仍然向下滚动，不会把整章压缩进一屏。调整时自动暂停滚动，偏好保存在本地。插件面板本身可拖动或收起，避免挡住正文。
...
- **键盘没反应：** 确认已更新到 1.4.2，刷新书页，再点击书页空白处。
